...
import { PictureInPicture, pipState, size } from '@/components/picture-in-picture';
...
export const SimViewer: React.FC<Props> = ({ renderer, cameraState, setCameraState, pfdState, setPfdState, setWindowDimensions } : Props) => {
    ...
    const memoizedRenderer = useMemo(() => {
        if (renderer === "unreal") {
            ...
            console.log("Error, renderer not valid, choose between 'unreal' and 'omniverse'")
            return null;
        }
        ...
        <div className="h-full w-full p-4">
            ...
            <div className="h-[calc(100vh-8rem)] w-full rounded-lg overflow-hidden border border-border relative">
                ...
                <div className="absolute top-0 left-0 z-10">
                    <NavBar 
                        handleCameraButton={() => setCameraState({...cameraState, show: !cameraState.show})}
                        handlePFDButton={() => setPfdState({...pfdState, show: !pfdState.show})}
                    />
                </div>
